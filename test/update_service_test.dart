  ...
  group('UpdateService.checkForUpdate', () {
    test('en Windows prefiere EXE sobre ZIP y APK', () async {
      ...
      final service = _serviceWithReleaseAssets([
        _asset('DMS_v2_windows_1.0.7_x64.zip'),
        _asset('DMS_v2_mobile_1.0.7.apk'),
        _asset('DMS_v2_windows_1.0.7_x64.exe'),
      ]);

      final update = await service.checkForUpdate();

      expect(update?.assetName, 'DMS_v2_windows_1.0.7_x64.exe');
    });
    ...
    test('en Android selecciona APK', () async {
      ...
      expect(update?.assetName, 'DMS_v2_mobile_1.0.7.apk');
    });
  });
}
        ...
        jsonEncode([
          {
            ...
            'body': 'Notas',
            'html_url':
                'https://github.com/ChaiGmzR/DMS_v2/releases/tag/v1.0.7',
            'assets': assets,
          },
        ]),
        200,
